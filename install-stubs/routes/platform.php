...
Route::screen('users', UserListScreen::class)
    ...
    ->breadcrumbs(function (Trail $trail) {
        return $trail->parent('platform.systems.index')
...
Route::screen('example-fields', ExampleFieldsScreen::class)
    ...
    ->breadcrumbs(function (Trail $trail) {
        return $trail->parent('platform.index')->push(__('Form controls'));
    });

Route::screen('example-layouts', ExampleLayoutsScreen::class)
    ->name('platform.example.layouts')
    ->breadcrumbs(function (Trail $trail) {
        return $trail->parent('platform.index')->push(__('Overview layouts'));
    });
